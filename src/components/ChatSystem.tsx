              ...
              <form onSubmit={handleCreateGroupSubmit} className="space-y-4 flex-1 flex flex-col overflow-hidden">
                ...
                <div className="grid grid-cols-2 gap-2 shrink-0">
                  <div className="space-y-1">
                    ...
                    <select
                      aria-label="Filtrar grado para crear grupo"
                      title="Filtrar grado"
...
backgroundBlendMode: themeMode === "dark" ? "multiply" : "soft-light",
backgroundColor: themeMode === "dark" ? "rgba(15, 23, 42, 0.95)" : "rgba(240, 244, 244, 0.9)"
                }}
              >
